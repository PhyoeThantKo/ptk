    ...
    <div class="px-16 mx-auto text-gray-100 dark:text-gray-100">
        <ul class="text-lg font-light pb-4 flex flex-wrap justify-center">
            <li class="w-1/2 md:w-1/3 lg:w-1/3">
                <div>
                    <h2 class="text-gray-100 dark:text-gray-100 text-3xl font-extrabold mb-1">
                        PTK
                    </h2>
                    <p>
            ...
            <li class="w-1/2 md:w-1/3 lg:w-1/3">
                <div class="text-center">
                    <h2 class="text-gray-100 text-md uppercase mb-3">
                        Site Map
                    </h2>
                    <ul>
            ...
            <li class="w-1/2 md:w-1/3 lg:w-1/3">
                <div class="text-center">
                    ...
                    <div class="grid grid-cols-4 gap-y-4 place-items-center max-w-xs mx-auto">
                      <a href="#">
                        <svg class="h-7 w-7 hover:text-gray-500 dark:hover:text-white transition-colors duration-200"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M15 10l-4 4l6 6l4 -16l-18 7l4 2l2 6l3 -4" /></svg>
                      </a>
                      <a href="#">
                        <svg class="h-7 w-7 hover:text-gray-500 dark:hover:text-white transition-colors duration-200"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round">  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z" /></svg>
                      </a>
                      <a href="#">
        ...
        <div class="text-center pt-3 border-t-2 w-2/6 font-light mx-auto">
